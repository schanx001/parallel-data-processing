...
/*
 *<h1>This class computes the averages with multithreaded fine lock method</h1>
...
public class FineLock implements Runnable
{
    ...
    public FineLock(List<String> strLst) {
        this.strLst=strLst;
    }
        ...
        for(int i=0;i<s.size();i++){
            ...
            if(temp[2].equals("TMAX")){
                if(result.containsKey(temp[0])){
                    ...
                    // synchronizing the accumulator data structure with dummy lock object
                    synchronized (lock) {
