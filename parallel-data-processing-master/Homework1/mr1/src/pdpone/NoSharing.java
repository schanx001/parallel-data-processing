...
/*
 *<h1>This class computes the averages with no sharing method</h1>
...
public class NoSharing implements Runnable {
    ...
    public NoSharing(List<String> strLst) {
        this.strLst=strLst;
    }
    ...
    public void noSharingInit() throws InterruptedException {
        ...
        NoSharing ns1,ns2,ns3;

        for(int i=0;i<10;i++) {
            start = System.currentTimeMillis();
            ns1 = new NoSharing(strLst);
            ns2 = new NoSharing(strLst);
            ns3 = new NoSharing(strLst);
